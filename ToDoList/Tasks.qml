...
Page{
        ...
        Rectangle{
            Component{
                ...
                Edit{
                    ...
                    index: position
                    Component.onDestruction: {
                        delegateModelToday.setGroups()
                        delegateModelTomorrow.setGroups()
                        delegateModelWeek.setGroups()
                        delegateModelMonth.setGroups()
                        delegateModelYear.setGroup()
                        delegateModelOther.setGroups()
                    }
                }
            }
            id: wrapper
    ...
    DelegateModel{
        ...
        function setGroups(){
            tomorrowGroup.remove(0,tomorrowGroup.count)
            var rowCount = myModel.count;
            items.remove(0,rowCount);
            for(var i =0;i<rowCount;i++){
                var entry = myModel.get(i);
    ...
    DelegateModel{
        ...
        function setGroups(){
            weekGroup.remove(0,weekGroup.count);
            var rowCount = myModel.count;
            items.remove(0,rowCount);
            for(var i =0;i<rowCount;i++){
                var entry = myModel.get(i);
    ...
    DelegateModel{
        ...
        function setGroups(){
            monthGroup.remove(0,monthGroup.count);
            var rowCount = myModel.count;
            items.remove(0,rowCount);
            for(var i =0;i<rowCount;i++){
                var entry = myModel.get(i);
    ...
    DelegateModel{
        ...
        function setGroup(){
            yearGroup.remove(0, yearGroup.count)
            var rowCount = myModel.count;
            items.remove(0,rowCount);
            for(var i =0;i<rowCount;i++){
                var entry = myModel.get(i);
    ...
    DelegateModel{
        ...
        function setGroups(){
            otherGroup.remove(0,otherGroup.count)
            var rowCount = myModel.count;
            items.remove(0,rowCount);
            for(var i =0;i<rowCount;i++){
                var entry = myModel.get(i);
